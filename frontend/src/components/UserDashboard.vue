  ...
  data(){
      return{
          products:[
              ...
              {id:4, name:'First phone',image:'http://localhost:5173/img/phone1.jpg', price:100},
              {id:5, name:'Second phone',image:'http://localhost:5173/img/phone2.jpg', price:150},
              {id:6, name:'Third phone',image:'http://localhost:5173/img/phone3.jpg', price:180},
          ]
      }
  }
