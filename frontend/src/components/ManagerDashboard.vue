<template>
  <div>
    ...
    <div class="row">
      <div v-for="(category, index) in categories" :key="index" class="col-md-4 d-flex justify-content-center">
        <div class="card bg-light mb-4 shadow-lg p-3 mb-5 bg-body rounded" style="width: 25rem;">
          ...
          <div class="card-body">
            ...
            <div class="overflow-auto" style="height: 400px;">
              <div v-for="product in productsByCategory[category.section_id]" :key="product.product_id" class="card mb-2 shadow p-3 mb-5 rounded" style="width: 310px;">
                <img
                ...
                />
                <div class="card-body">
                  <center><h5 class="card-title" style="color: black">{{ product.name }}</h5></center>
                  ...
                  <div class="d-flex justify-content-center align-items-center">
                    <a href="#" @click="updateProduct(product.product_id)"><button class="btn btn-outline-warning"><i class="bi bi-pencil-square"></i>Edit</button></a>
                    <span style="flex-grow: 0.5;"></span>
                    <a href="#" @click="deleteProduct(product.product_id)"><button class="btn btn-outline-danger"><i class="bi bi-trash"></i>Delete</button></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="d-flex justify-content-between">
                <a href="#" @click="addProduct(category.section_id)"><button class="btn btn-outline-primary"><i class="fa fa-plus-circle"></i>Add Items</button></a>
                <span style="flex-grow: 1;"></span>
                <a href="#" @click="updateCategory(category.section_id)"><button class="btn btn-outline-warning"><i class="bi bi-pencil-square"></i></button></a>
                <span style="flex-grow: 0.3;"></span>
                <a href="#" @click="deleteCategory(category.section_id)"><button class="btn btn-outline-danger"><i class="bi bi-trash"></i></button></a>
              </div>
            </div>
          </div>
        </div>
