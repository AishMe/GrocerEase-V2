          ...
          <div class="card-body">
            ...
            <div>
              ...
              <div class="d-flex justify-content-between">
                <a href="#" @click="addProduct(category.category_id)"
                  ><button class="btn btn-outline-primary">
                    <i class="fa fa-plus-circle"></i>Add Items
                  </button></a
                >
                <span style="flex-grow: 1"></span>
                <a href="#" @click="updateCategory(category.category_id)"
                  ><button class="btn btn-outline-warning">
    ...
    async fetchProductsbyCategories() {
      try {
        ...
        if (response.ok) {
          ...
          console.log('Products by Categories: ', responseData.productsByCategory)
        } else {
